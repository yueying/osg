// El siguiente bloque ifdef muestra la forma est醤dar de crear macros que facilitan
// la exportaci髇 de archivos DLL. Todos los archivos de este archivo DLL se compilan con el s韒bolo Q3BSP_EXPORTS
// definido en la l韩ea de comandos. Este s韒bolo no se debe definir en ning鷑 proyecto
// que utilice este archivo DLL. De este modo, otros proyectos cuyos archivos de c骴igo fuente incluyan el archivo
// interpreta que las funciones Q3BSP_API se importan de un archivo DLL, mientras que este archivo DLL interpreta los s韒bolos
